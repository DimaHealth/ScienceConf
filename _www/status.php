...
$res = mysqli_query($connect, $sql);
  ...
  echo '<tr><th>ID</th><th>Статус</th>
   <th></th><th></th></tr>'; 
  while ( $item = mysqli_fetch_array( $res ) ) 
  { 
    echo '<tr class="my-bold-font">';  
	echo '<td>'.$item['IDStatus'].'</td>'; 
    echo '<td>'.$item['Status'].'</td>'; 
    echo '<td><a href="?action=editform&id='.$item['IDStatus'].'">Ред.</a></td>'; 
    echo '<td><a href="?action=delete&id='.$item['IDStatus'].'">Удл.</a></td>'; 
    echo '</tr>'; 
  } 
  echo '</table>';
...
{ 
echo '<h2>Добавить</h2>'; 
include("templates/addStatus.php");
...
{ 
  ...
  include("templates/updateStatus.php");
} 
